...
kmip_print_attribute_value(int indent, enum attribute_type type, void *value)
{
    ...
    switch(type)
    {
        ...
        case KMIP_ATTR_CRYPTOGRAPHIC_PARAMETERS:
        kmip_print_cryptographic_parameters(indent, (CryptographicParameters *)value);
        printf("\n");
        break;
        ...
        if(value->value != NULL)
        {
            switch(value->type)
            {
                ...
                *(int32*)value->value = KMIP_UNSET;
                ...
                case KMIP_ATTR_CRYPTOGRAPHIC_PARAMETERS:
                kmip_free_cryptographic_parameters(ctx, (CryptographicParameters *)value->value);
                break;
    ...
    if(a != b)
    {
        ...
        if(a->value != b->value)
        {
            ...
            switch(a->type)
            {
                ...
                case KMIP_ATTR_CRYPTOGRAPHIC_PARAMETERS:
                return (kmip_compare_cryptographic_parameters((CryptographicParameters *)a->value, (CryptographicParameters *)b->value));
                break;
