                  ...
                  const char *ca_certificate)
{
    ...
    if(list != NULL)
    {
        ...
        LinkedListItem *item2 = kmip_context.calloc_func(kmip_context.state, 1, sizeof(LinkedListItem));
        if(item2 != NULL)
        {
    	    item2->data = &a[2];
        ...
        LinkedListItem *item3 = kmip_context.calloc_func(kmip_context.state, 1, sizeof(LinkedListItem));
        if(item3 != NULL)
        {
    	    item3->data = &a[3];
