...
static int parse(const int aOpt, const char *aArg)
{
	...
	case 's':
		...
		break;
	case 'k':
		strncpy_s(filenamePrivatekeyblobOutput, sizeof(filenamePrivatekeyblobOutput), aArg, PATH_MAX);
		break;
	case 'p':
		strncpy_s(filenamePublickeyOutput, sizeof(filenamePublickeyOutput), aArg, PATH_MAX);
		break;
	case 'q':
